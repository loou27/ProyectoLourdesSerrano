...
/** Aplicación de consola para gestionar clientes, productos y pedidos. */
public class Main {
    ...
    /** Scanner global para lectura desde consola. */
    ...
    /** Añade un nuevo cliente desde consola. */
    ...
    /** Añade un nuevo producto desde consola. */
    ...
    /** Modifica el precio y cantidad de un producto. */
    ...
    /** Añade un nuevo pedido desde consola. */
    public static void añadirPedido() {
        ...
        System.out.print(
            "Método pago (EFECTIVO / TARJETA / BIZUM): "
        );
